...
export const MapComponent: FC<Props> = ({
  ...
  const handleOnClickPolygon = (e: LeafletMouseEvent, index: number) => {
    ...
    const neighborhoodIdx = String(neighborhoods[index].idNeighborhood);
    setSelectedNeighborhoodID(neighborhoodIdx);

    if (location.pathname === Pages.NuevoMapaPrueba) {
      navigate(
        {
      ...
      {neighborhoods.map((neighborhood, idx) => {
        return (
          <Polygon
            ...
            pathOptions={{
              fillColor:
                neighborhood.color ?? getNeighborhoodColor(idx, selectedNeighborhoodID),
              color:
                neighborhood.color ?? getNeighborhoodColor(idx, selectedNeighborhoodID),
            }}
          >
            ...
            {showPopup ? (
              ...
              >
                <Flex flexDirection={"column"}>
                  ...
                  >{`Barrio: ${neighborhood.neighborhoodName}`}</Text>
